...
const AddQuestion = () => {
  ...
  const dataSubmit = async (e) => {
    ...
    // console.log(post);
    console.log(Convert);
    await axios.post("http://localhost:3009/question", Convert);
    ...
    <div className="add-ques">
      ...
      <form className="post-form" action="" onSubmit={dataSubmit}>
        ...
        <div className="field-1">
          ...
          <div className="ans1">
            ...
            {/* <input
              ...
              onChange={handleChange}
            /> */}
            <select name="ans1" value={post.ans1} id="input-1" className='form-input' onChange={handleChange}>
        ...
        <div className="field-2">
          ...
          <div className="ans2">
            ...
            {/* <input
              ...
              onChange={handleChange}
            /> */}
             <select name="ans2" value={post.ans2} id="input-2" className='form-input' onChange={handleChange}>
              <option value="select">Select The Value</option>
              <option value="true">True</option>
              <option value="false">False</option>
            </select>
        ...
        <div className="field-3">
          ...
          <div className="ans3">
            ...
            {/* <input
              ...
              onChange={handleChange}
            /> */}
             <select name="ans3" value={post.ans3} id="input-3" className='form-input' onChange={handleChange}>
              <option value="select">Select The Value</option>
              <option value="true">True</option>
              <option value="false">False</option>
            </select>
        ...
        <div className="field-4">
          ...
          <div className="ans4">
            ...
            {/* <input
              ...
              onChange={handleChange}
            /> */}
             <select name="ans4" value={post.ans4} id="input-4" className='form-input' onChange={handleChange}>
              <option value="select">Select The Value</option>
              <option value="true">True</option>
              <option value="false">False</option>
            </select>
        ...
        <div className="btns">
          ...
          <button type="submit" className="post-data">
            Post
          </button>
        </div>
      </form>
